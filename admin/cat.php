...
if (isset($_POST['c_submit'])) {
  $cname= $_POST['c_name'];
  $cicon= $_POST['c_icon'];
  $insert_sql= "INSERT INTO categoty(name, icon) VALUES ('$cname','$cicon')";
...
//Select Category
$select_sql= "SELECT * FROM categoty";
          ...
          <div class="card mb-4">
            <div class="card-body">
             ...
             <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
              ...
              <div class="mb-3">
                <button class="btn btn-success w-25" type="submit" name="c_submit">Submit</button>
